<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("Bank");
					i++;
					myInputs[i] = document.getElementById("Fund");
					i++;
...
<div id="container">
	<div id="header">
		User Task Form: edoc.SetupUser(RW)
	</div>
	<div id="content">
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="firstName" type="text" class="textbox" id="firstName" value="${firstName}" />
                            		</div>
              	
                            		<label for="name">lastname</label>
                            		<div class="div_texbox">
                              		<input name="lastname" type="text" class="textbox" id="lastname" value="${lastname}" />
                            		</div>
              	
                            		<label for="name">Bank</label>
                            		<div class="div_texbox">
                              		<input name="Bank" type="text" class="textbox" id="Bank" value="${Bank}" />
                            		</div>
              	
                            		<label for="name">Fund</label>
                            		<div class="div_texbox">
                              		<input name="Fund" type="text" class="textbox" id="Fund" value="${Fund}" />
                            		</div>
