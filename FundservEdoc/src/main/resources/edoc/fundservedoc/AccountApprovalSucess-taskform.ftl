<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("Disapproved");
					i++;
		...
		var j=0;
					...
					j++;
						if(notEmpty(myInputs[j]) && !isNumeric(myInputs[j])) {
							alert("Please enter valid Disapproved");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: edoc.AccountApprovalSucess
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<label for="name">Disapproved</label>
                            		<div class="div_texbox">
                              		<input name="Disapproved" type="text" class="textbox" id="Disapproved" value="${Disapproved}" />
                            		</div>
